...
public class SkyOneAirlinesFlightData {
    ...
    public FlightData toFlightData(){
        ...
        flightData.setDepartureTime(this.flightDepartureTime);
        flightData.setDepartureAirportCode(this.iataDepartureCode);
        flightData.setArrivalTime(this.flightArrivalTime);
        flightData.setArrivalAirportCode(this.iataArrivalCode);
        flightData.setFlightNumber(this.flightNumber);
        flightData.setConfirmationCode(this.confirmation);
        return flightData;
    }
}