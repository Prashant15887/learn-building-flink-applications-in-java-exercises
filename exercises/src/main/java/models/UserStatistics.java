...
public class UserStatistics {
    ...
    public UserStatistics merge(UserStatistics inObj){
        assert(this.emailAddress.equals(inObj.emailAddress));

        UserStatistics outObj = new UserStatistics();
        /*outObj.setEmailAddress(inObj.emailAddress);
        outObj.setTotalFlightDuration(this.totalFlightDuration.plus(inObj.getTotalFlightDuration()));
        outObj.setNumberOfFlights(this.numberOfFlights + inObj.getNumberOfFlights());*/

        outObj.emailAddress = inObj.emailAddress;
        outObj.totalFlightDuration = this.totalFlightDuration.plus(inObj.totalFlightDuration);
        outObj.numberOfFlights = this.numberOfFlights + inObj.numberOfFlights;
